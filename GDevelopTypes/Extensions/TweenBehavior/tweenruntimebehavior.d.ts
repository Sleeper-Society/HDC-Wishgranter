declare namespace gdjs {
    ...
    export class TweenRuntimeBehavior extends gdjs.RuntimeBehavior {
        ...
        applyBehaviorOverriding(behaviorData: BehaviorData): boolean;
        getNetworkSyncData(syncOptions: GetNetworkSyncDataOptions): TweenBehaviorNetworkSyncData;
        updateFromNetworkSyncData(networkSyncData: TweenBehaviorNetworkSyncData, options: UpdateFromNetworkSyncDataOptions): void;
         ...
         * @param destroyObjectWhenFinished Destroy this object when the tween ends
         */
        addObjectPositionZTween2(object3DBehavior: any, identifier: string, toZ: number, easing: string, duration: float, destroyObjectWhenFinished: boolean): void;
         ...
         * @param destroyObjectWhenFinished Destroy this object when the tween ends
         */
        addObjectRotationXTween(object3DBehavior: any, identifier: string, toAngle: float, easing: string, duration: float, destroyObjectWhenFinished: boolean): void;
        /**
         ...
         * @param destroyObjectWhenFinished Destroy this object when the tween ends
         */
        addObjectRotationYTween(object3DBehavior: any, identifier: string, toAngle: float, easing: string, duration: float, destroyObjectWhenFinished: boolean): void;
        /**
         ...
         * @param scaleFromCenterOfObject Scale the transform from the center of the object (or point that is called center), not the top-left origin
         */
        addObjectScaleTween3(identifier: string, toScale: number, easing: string, duration: float, destroyObjectWhenFinished: boolean, scaleFromCenterOfObject: boolean): void;
        /**
         ...
         * @param destroyObjectWhenFinished Destroy this object when the tween ends
         */
        addObjectDepthTween2(object3DBehavior: any, identifier: string, toDepth: float, easing: string, duration: float, destroyObjectWhenFinished: boolean): void;
