declare namespace gdjs {
    namespace evtTools {
        namespace tween {
            ...
            type GetTimeSourceFunction = (tweenInformationNetworkSyncData: TweenInformationNetworkSyncData) => TimeSource;
            type GetTweenSetterFunction = (tweenInformationNetworkSyncData: TweenInformationNetworkSyncData) => (value: any) => void;
            type GetOnFinishFunction = (tweenInformationNetworkSyncData: TweenInformationNetworkSyncData) => (() => void) | null;
            /**
            ...
            export class TweenManager {
                 ...
                 */
                addSimpleTween(identifier: string, timeSource: TimeSource, totalDuration: number, easingIdentifier: string, interpolate: Interpolation, initialValue: float, targetedValue: float, setValue: (value: float) => void, tweenInformation: TweenInformation, onFinish?: (() => void) | null): void;
                /**
                 * Add a tween on several values.
                 */
                addMultiTween(identifier: string, timeSource: TimeSource, totalDuration: number, easingIdentifier: string, interpolate: Interpolation, initialValue: Array<float>, targetedValue: Array<float>, setValue: (value: Array<float>) => void, tweenInformation: TweenInformation, onFinish?: (() => void) | null): void;
                /**
                 * Tween exists.
                ...
                _addActiveTween(tween: TweenInstance<float> | TweenInstance<Array<float>>): void;
                _removeActiveTween(tween: TweenInstance<float> | TweenInstance<Array<float>>): void;
                /**
                 * Get tween progress.
                 * @param identifier Unique id to identify the tween
                ...
                updateFromNetworkSyncData(syncData: TweenManagerNetworkSyncData, getTimeSource: GetTimeSourceFunction, getTweenSetter: GetTweenSetterFunction, getOnFinish: GetOnFinishFunction): void;
            }
             ...
             * @category Other extensions > Tween
             */
            export type Interpolation = (from: float, to: float, progress: float) => float;
            /**
             * A tween.
             * @ignore
             */
             ...
             * @category Other extensions > Tween
             */
            export abstract class AbstractTweenInstance<T> implements TweenInstance<T> {
                ...
                constructor(timeSource: TimeSource, totalDuration: float, easing: (progress: float) => float, easingIdentifier: string, interpolate: Interpolation, tweenInformation: TweenInformation, onFinish?: (() => void) | null);
                step(): void;
            ...
            export class SimpleTweenInstance extends AbstractTweenInstance<float> {
                ...
                currentValue: float;
                constructor(timeSource: TimeSource, totalDuration: float, easing: (progress: float) => float, easingIdentifier: string, interpolate: Interpolation, initialValue: float, targetedValue: float, setValue: (value: float) => void, tweenInformation: TweenInformation, onFinish?: (() => void) | null);
             ...
             * @category Other extensions > Tween
             */
            export class MultiTweenInstance extends AbstractTweenInstance<Array<float>> {
                initialValue: Array<float>;
                targetedValue: Array<float>;
                setValue: (value: Array<float>) => void;
                currentValues: number[];
                constructor(timeSource: TimeSource, totalDuration: float, easing: (progress: float) => float, easingIdentifier: string, interpolate: Interpolation, initialValue: Array<float>, targetedValue: Array<float>, setValue: (value: Array<float>) => void, tweenInformation: TweenInformation, onFinish?: (() => void) | null);
                protected _updateValue(): void;
                getValue(): float;
             ...
             */
            export const ease: (easingValue: string, fromValue: float, toValue: float, weighting: float) => number;
            /**
             * @category Other extensions > Tween
             */
