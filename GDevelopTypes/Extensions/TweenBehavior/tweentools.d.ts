declare namespace gdjs {
    ...
    namespace evtTools {
        namespace tween {
            const tweenSetterFactory: (runtimeScene: RuntimeScene) => (tweenInformation: TweenInformationNetworkSyncData) => ((value: float) => void) | (([hue, saturation, lightness]: Array<float>) => void);
