declare namespace gdjs {
    ...
    namespace fileSystem {
        ...
        const makeDirectoryAsync: (directory: string, resultVar: gdjs.Variable) => ResolveTask | PromiseTask<void>;
        /**
        ...
        const saveStringToFileAsyncTask: (text: string, savePath: string, resultVar: gdjs.Variable) => ResolveTask | PromiseTask<void>;
        /**
        ...
        const saveVariableToJSONFileAsyncTask: (variable: gdjs.Variable, savePath: string, resultVar: gdjs.Variable) => ResolveTask | PromiseTask<void>;
        /**
        ...
        const loadVariableFromJSONFileAsyncTask: (variable: gdjs.Variable, loadPath: string, resultVar: gdjs.Variable, removeCRCharacters: boolean) => ResolveTask | PromiseTask<void>;
        /**
        ...
        const loadStringFromFileAsyncTask: (variable: gdjs.Variable, loadPath: string, resultVar: gdjs.Variable, removeCRCharacters: boolean) => ResolveTask | PromiseTask<void>;
        /**
        ...
        const deleteFileAsyncTask: (filePath: string, resultVar: gdjs.Variable) => ResolveTask | PromiseTask<void>;
        /**
         * Reads the contents of a directory.
         * @param directoryPath Path to the directory.
         * @param resultVar The variable where to store the result of the operation.
         */
        const readdir: (directoryPath: string, resultVar: gdjs.Variable) => void;
        /**
         * Read a directory's contents asynchronously.
         * @param directoryPath Path to the directory
         * @param resultVar The variable where to store the result of the operation
         */
        const readdirAsync: (directoryPath: string, resultVar: gdjs.Variable) => ResolveTask | PromiseTask<void>;
        /**
