declare namespace gdjs {
    ...
    class HowlerSound {
        ...
        constructor(howl: Howl, volume: float, loop: boolean, rate: float, audioResourceName: string);
        /**
     ...
     * @category Audio > Sound Manager
     */
    class HowlerSoundManager implements gdjs.ResourceManager {
        ...
        _muteEverythingReasons: Set<string>;
         ...
         */
        private _getSoundUrlsFromResource;
        /**
         * @param resource
         * @returns Resource file
         */
        private _getDefaultSoundUrl;
        /**
         * Preload audio file
         * @param resource
         * @param isMusic
         ...
         */
        unloadAll(): void;
        playSound(soundName: string, loop: boolean, volume: float, pitch: float, seek?: float): void;
        playSoundOnChannel(soundName: string, channel: integer, loop: boolean, volume: float, pitch: float, seek?: float): void;
        getSoundOnChannel(channel: integer): HowlerSound | null;
        playMusic(soundName: string, loop: boolean, volume: float, pitch: float, seek?: float): void;
        playMusicOnChannel(soundName: string, channel: integer, loop: boolean, volume: float, pitch: float, seek?: float): void;
        getMusicOnChannel(channel: integer): HowlerSound | null;
        setSoundSpatialPositionOnChannel(channel: number, x: number, y: number, z: number): void;
        _clearCachedSpatialPosition(): void;
