declare namespace gdjs {
    ...
    class Variable {
        ...
        static getVariableDataFromNetworkSyncData: (syncData: VariableNetworkSyncData) => VariableData;
        getNetworkSyncData(syncOptions: GetNetworkSyncDataOptions): UnnamedVariableNetworkSyncData | undefined;
        getStructureNetworkSyncData(variable: gdjs.Variable): VariableNetworkSyncData[] | undefined;
        updateFromNetworkSyncData(networkSyncData: VariableNetworkSyncData, options: UpdateFromNetworkSyncDataOptions): void;
        /**
         ...
         */
        _pushVariable(variable: gdjs.Variable): void;
        /**
