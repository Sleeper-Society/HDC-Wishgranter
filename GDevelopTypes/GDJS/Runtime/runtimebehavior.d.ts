declare namespace gdjs {
    ...
    class RuntimeBehavior {
        ...
        getNetworkSyncData(syncOptions: GetNetworkSyncDataOptions): BehaviorNetworkSyncData;
        /**
         * Update the behavior properties using the provided data.
         * @param networkSyncData The new properties of the behavior.
         */
        updateFromNetworkSyncData(networkSyncData: BehaviorNetworkSyncData, options: UpdateFromNetworkSyncDataOptions): void;
        /**
