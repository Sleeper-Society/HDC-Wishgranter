declare namespace gdjs {
    ...
    class RuntimeScene extends gdjs.RuntimeInstanceContainer {
        ...
        _idToCallbackMap: null | Map<string, (runtimeScene: gdjs.RuntimeScene, asyncObjectsList: gdjs.LongLivedObjectsList) => void>;
        ...
        _resourcesUnloading: 'at-scene-exit' | 'never' | 'inherit';
         ...
         */
        loadFromScene(sceneAndExtensionsData: SceneAndExtensionsData | null, options?: {
        ...
        getNetworkSyncData(syncOptions: GetNetworkSyncDataOptions): LayoutNetworkSyncData | null;
        updateFromNetworkSyncData(syncData: LayoutNetworkSyncData, options: UpdateFromNetworkSyncDataOptions): void;
