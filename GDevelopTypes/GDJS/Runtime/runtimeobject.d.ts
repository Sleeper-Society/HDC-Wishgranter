declare namespace gdjs {
    ...
    class RuntimeObject implements EffectsTarget, gdjs.EffectHandler {
         ...
         */
        constructor(instanceContainer: gdjs.RuntimeInstanceContainer, objectData: ObjectData, instanceData: InstanceData | undefined);
        /**
         ...
         */
        updateFromNetworkSyncData(networkSyncData: ObjectNetworkSyncData, options: UpdateFromNetworkSyncDataOptions): void;
        /**
         ...
         */
        static collisionTest(obj1: gdjs.RuntimeObject, obj2: gdjs.RuntimeObject, ignoreTouchingEdges: boolean, ignoredObject1Polygon?: gdjs.Polygon | null): boolean;
        /**
