declare namespace gdjs {
    namespace evtTools {
        namespace object {
            ...
            const _isTurnedTowardObject: (obj1: gdjs.RuntimeObject, obj2: gdjs.RuntimeObject, tolerance: float) => boolean;
            const isTurnedTowardObject: (objectsLists1: ObjectsLists, objectsLists2: ObjectsLists, tolerance: float, inverted: boolean) => boolean;
            ...
            const pickNearestObject: (objectsLists: ObjectsLists, x: float, y: float, inverted?: boolean) => boolean;
     ...
     */
    type LongLivedObjectsListNetworkSyncData = {
        objectsLists: {
    ...
    class LongLivedObjectsList {
        ...
        private localVariablesContainers;
        private callbacks;
        private parent;
        /**
        ...
        getNetworkSyncData(syncOptions: GetNetworkSyncDataOptions): LongLivedObjectsListNetworkSyncData;
        updateFromNetworkSyncData(syncData: LongLivedObjectsListNetworkSyncData, runtimeScene: gdjs.RuntimeScene, syncOptions: UpdateFromNetworkSyncDataOptions): void;
    }
}
