declare namespace gdjs {
    ...
    abstract class RuntimeInstanceContainer {
         ...
         */
        createObjectsFrom(data: InstanceData[], xPos: float, yPos: float, zPos: float, trackByPersistentUuid: boolean, options?: {
        ...
        _updateObjectsForInGameEditor(): void;
        /**
         * Call each behavior stepPostEvents method.
         */
        _stepBehaviorsPostEvents(): void;
        /**
