...
export function replaceCode0(hyperspace_path: string, game: Game, finsher: (on_finished?: () => void) => void): Promise<string | [string, LoadSequenceElement[]]>{ 
    return getTemporaryReplacedFile(hyperspace_path, game,
    finsher,
    'code0.js',
    [
        [
