...
#### Loading the mod
* `load` (required): A function for inserting new data into the game. This is where calls to `AddCard`,`AddEncounter`,`AddStartingDeck`, and `AddKeyword` should occur. Returns either void or a `load_sequence_element` array.
